...
class CycleBackWidget extends AbstractStreamWidget
{
    ...
    {
        return new HtmlRenderResult('<div>Cycle Back</div>');
    }
    ...
    {
        return [
            new LayoutSlot(DefaultSlotName::MAIN, SlotAcceptanceMode::ANY),
        ];
    }
}
